 ...
 */
public class SendComponentRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware, ResourceLoaderAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry,
        ...
        scanner.addIncludeFilter(new AnnotationTypeFilter(SendMessage.class));
        ...
        for (String basePackage : basePackages) {
            ...
            for (BeanDefinition beanDefinition : candidateComponents) {
                if (beanDefinition instanceof AnnotatedBeanDefinition) {
                    ...
                    // 生成代理
                    registrarSendComponent(annotationMetadata, registry);
                }
    ...
    private void registrarSendComponent(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
